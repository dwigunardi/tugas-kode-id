...
<body>
  <nav class="navbar navbar-dark navbar-expand-lg fixed-top navbarScroll">
    <div class="container">
      <a class="navbar-brand" href="#">DwiGM</a>
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hero-text">
          <h2 class="hero_title">Hello, Saya Dwi GM</h2>
          <p class="hero_desc">Saya seorang mahasiswa yang sedang belajar menjadi Web Developer</p>
        </div>
      </div>
    </div>
  </section>
  <section id="about">
    <div class="container mt-4 pt-4">
      ...
      <div class="row mt-4">
        <div class="col-lg-4">
          <img src="images/140797013_4230806206936088_3724772766092871798_n.jpg" class="imageAboutPage" alt="">
        </div>
        ...
        <div class="col-lg-8">
          ...
          <div class="row mt-3">
            <div class="col-md-6">
              <ul>
                <li>Name: Dwi Gunardi Meinaki</li>
                <li>Age: 24</li>
      ...
      <div class="row">
        <div class="col-lg-3 col-sm-6">
          <div class="card" style="width: 18rem; height: 25rem;">
            <img src="./images/blogs2.webp" class="card-img-top" alt="...">
            <div class="card-body">
        ...
        <div class="col-lg-3 col-sm-6">
          <div class="card" style="width: 18rem; height: 25rem;">
            <img src="./images/blogs1.jpg" class="card-img-top" alt="...">
            <div class="card-body">
              <h5 class="card-title">Card title</h5>
              <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's
                content.</p>
        ...
        <div class="col-lg-3 col-sm-6">
          <div class="card" style="width: 18rem; height: 25rem;">
            <img src="./images/blogs3.jpg" class="card-img-top" alt="...">
            <div class="card-body">
              <h5 class="card-title">Card title</h5>
              <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's
                content.</p>
        ...
        <div class="col-lg-3 col-sm-6">
          <div class="card" style="width: 18rem; height: 25rem;">
            <img src="./images/blogs4.jpg" class="card-img-top" alt="...">
            <div class="card-body">
              <h5 class="card-title">Card title</h5>
              <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's
                content.</p>
      ...
      <div class="row mt-4">
        <div class="col-lg-6">
          <div style="overflow:hidden;max-width:100%;width:500px;height:500px;">
            <div id="googlemaps-display" style="height:80%; width:100%;max-width:100%;"><iframe
                style="height:100%;width:100%;border:0;" frameborder="0"
                src="https://www.google.com/maps/embed/v1/place?q=Sukabumi,+jln+pelabuhan+2&key=AIzaSyBFw0Qbyq9zTFTd-tUY6dZWTgaQzuU17R8"></iframe>
            </div><a class="embedded-maphtml" rel="nofollow" href="https://www.embed-map.com"
              id="enablemap-data">https://www.embed-map.com</a>
            <style>
              .map-generator {
                max-width: 100%;
                max-height: 100%;
        ...
        <div class="col-lg-6">
          ...
          <button type="button" class="btn btn-primary mt-3">Contact Me</button>
